...
#' @param borderDash an optional list of size
...
#' @export
cjsSeries <- function(cjs, data, type, borderDash, label, scale){
  UseMethod("cjsSeries")
}
...
#' @keywords internal
#' @export
cjsSeries.cjs_bar <- function(cjs, data, type = "bar", borderDash = NULL, label = NULL, scale = NULL){
  n <- length(cjs$x$data$datasets)
  colours <- cjs %>% cjs_get_colours(n)
  dataset <- list(c(data = list(data), colours, label = label, borderDash = borderDash))
...
#' @keywords internal
#' @export
cjsSeries.cjs_line <- function(cjs, data, type = "line", borderDash = NULL, label = NULL, scale = NULL){
  cjsSeries.cjs_bar(cjs, data, type, borderDash, label, scale)
}

#' @describeIn cjsSeries Add series to a horizontal bar chart
#' @keywords internal
#' @export
cjsSeries.cjs_horizontalBar <- function(cjs, data, borderDash = NULL, type = "horizontalBar", label = NULL, scale = NULL){
  cjsSeries.cjs_bar(cjs, data, type, label, borderDash, scale)
}

#' @describeIn cjsSeries Add series to a radar chart
#' @keywords internal
#' @export
cjsSeries.cjs_radar <- function(cjs, data, type = NULL, borderDash = NULL,  label = NULL, scale = NULL){
  cjsSeries.cjs_bar(cjs, data, type, borderDash, label, scale)
}
...
#' @keywords internal
#' @export
cjsSeries.cjs_pie <- function(cjs, data, type = NULL, borderDash = NULL, label = NULL, scale = NULL){
  n <- length(data)
  colours <- cjs %>% cjs_get_colours(n)
