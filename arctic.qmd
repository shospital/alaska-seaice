...
The time series plot and data summary below span from 1985 to the lastest available data of the Alaskan Arctic. The labels (column names) used include:
...
#| message: false
    ...
    dfile_arctic = readRDS(file = "data/iceExt_arctic.rds")
