...
<img src="img/nbering.png" style="float: right; width: 200px;" alt="Northern Bering">
...
#| results: 'hide'
    ...
    dfile_nb = readRDS(file ="iceExt_nb.rds")
...
*Sea Ice Concentration, NOAA/NSIDC Climate Data Record V4, Northern Hemisphere, 25km, Science
